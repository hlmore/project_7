...
plastic_regions_grouped <-
  ...
  summarize(meanLong=mean(na.omit(long)), 
            ...
            totalStraw=sum(SUM_Soft_Straw, na.rm=TRUE),
            totalCig=sum(SUM_Soft_CigaretteButts, na.rm=TRUE),
            totalBag=sum(SUM_Soft_Bag),
            totalNet=sum(Fishing_Net)
  )
